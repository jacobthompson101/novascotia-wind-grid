...
I added novel work with scikit-learn, and also NVidia CUDA machine learning tools, cuml/cudf packages, for creating cross validation of mock model data for the 2025 year based on historical OASIS Load MW values and datetimes.
...
14. Nova Scotia Government (2025). West Wind: [https://novascotia.ca/wind-west/](https://novascotia.ca/wind-west/) 
15. NetZeroAtlantic (2023), Value Mapping Nova Scotia’s Offshore Wind Resources, Retrieved from: [https://netzeroatlantic.ca/sites/default/files/2023-04/Value%20Mapping%20Nova%20Scotia%20Offshore%20Wind%20Resources.pdf](https://netzeroatlantic.ca/sites/default/files/2023-04/Value%20Mapping%20Nova%20Scotia%20Offshore%20Wind%20Resources.pdf)
16. "Pearre N, Swan L (2020). Maritime Regional Wind Energy Resources: Determining preferred regions for additional onshore and offshore wind energy development."
...
17. Nova Scotia Wind Grid (2024), GitHub code repo, Retrieved from: [https://github.com/jacobthompson101/novascotia-wind-grid](https://github.com/jacobthompson101/novascotia-wind-grid)
18. Bubble Curtain graphic: [https://www.maritime-executive.com/article/vineyard-wind-tries-bubble-curtain-system-to-cut-pile-driving-noise](https://www.maritime-executive.com/article/vineyard-wind-tries-bubble-curtain-system-to-cut-pile-driving-noise)
19. Ocean Soundscape Map. Meridian: [https://meridian.cs.dal.ca/ocean-soundscape-atlas/](https://meridian.cs.dal.ca/ocean-soundscape-atlas/)
20. Kadlu OceanNoise Python Package: [https://docs.meridian.cs.dal.ca/kadlu/install.html](https://docs.meridian.cs.dal.ca/kadlu/install.html)
21. Latest Kadlu Ocean Noise Python GitHub: [https://github.com/meridian-analytics/kadlu](https://github.com/meridian-analytics/kadlu) 
22. New England Maritimes Offshore Energy Corridor (NEMOEC): [https://nemoec.com](https://nemoec.com)
23. Understanding underwater acoustic noise in decibel (2025): [https://uw.pressbooks.pub/ocean285/chapter/the-decibel-scale/#:~:text=When%20using%20decibels%2C%20the%20term,loss%20term%20for%20acoustic%20energy.](https://uw.pressbooks.pub/ocean285/chapter/the-decibel-scale/#:~:text=When%20using%20decibels%2C%20the%20term,loss%20term%20for%20acoustic%20energy.) 
24. Wikipedia (2025), Underwater Acoustics: [https://en.wikipedia.org/wiki/Underwater_acoustics](https://en.wikipedia.org/wiki/Underwater_acoustics ) 
25. BBC (2025), Big Bubble Curtains protecting Porpoises:  [https://www.bbc.com/future/article/20231106-the-big-bubble-curtains-protecting-porpoises-from-wind-farm-noise](https://www.bbc.com/future/article/20231106-the-big-bubble-curtains-protecting-porpoises-from-wind-farm-noise) 
26. GWEC (2025), Global Offshore Wind Report 2025: [https://www.gwec.net/reports/globaloffshorewindreport](https://www.gwec.net/reports/globaloffshorewindreport) 
27. Wikipedia (2025), OffShore Wind Farms in UK:  [https://en.wikipedia.org/wiki/List_of_offshore_wind_farms_in_the_United_Kingdom](https://en.wikipedia.org/wiki/List_of_offshore_wind_farms_in_the_United_Kingdom ) 
28. WMA (2025), Big Battery Project Announced: [https://wmalimited.com/press-release-trenton-battery-energy-storage-project-announces-february-2025-open-house/](https://wmalimited.com/press-release-trenton-battery-energy-storage-project-announces-february-2025-open-house/) 
29. NRStor (2025), Trenton Big Battery Project: [https://nrstor.com/trenton-battery-project/](https://nrstor.com/trenton-battery-project/)
30. Grant Chalmers (2025), Heatmap wind farm capacity factors for Australian states across Q1: [https://www.linkedin.com/posts/grant-chalmers_rstats-ggplot2-electricity-activity-7330354717115473920-qiyZ](https://www.linkedin.com/posts/grant-chalmers_rstats-ggplot2-electricity-activity-7330354717115473920-qiyZ) 
31. Variate Energy (2025), Baseload Factor, [https://variate.energy/resources/baseload-factor](https://variate.energy/resources/baseload-factor)
